...
-- QUERY daily data
SELECT d.e_date, d.ad_place, d.e_exposure, d.e_count, ((d.e_exposure - d.e_count) / d.e_exposure) as gap, d.e_earn, (d.e_earn * i.rebate) AS net_income, i.ecpm, (d.e_earn / d.e_count) * 1000 AS dym_ecpm FROM earn_daily_journal d JOIN earn_channel_info i ON d.channel = i.channel;